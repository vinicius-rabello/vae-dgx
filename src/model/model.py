...
init_dim = 32 # initial number of filters
image_channels = 1 # MNIST images are grayscale
latent_dim = 5 # latent dimension for sampling
...
class VariationalAutoEncoder(nn.Module):
    def __init__(self, init_dim=init_dim,latent_dim=latent_dim, kernel_size = kernel_size):
        super().__init__()
    ...
    def decode(self,z):
        x = self.fc2(z)
        x = torch.reshape(x, (-1, init_dim*32,1,1))
